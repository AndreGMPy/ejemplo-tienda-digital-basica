...
Si pones solo `producto1.jpeg`, el backend lo convierte automáticamente a:

```text
/assets/producto1.jpeg
```

Para que se vea la imagen real, guarda ese archivo dentro de `public/assets`. Si no existe, el frontend usa una imagen demo de respaldo.
